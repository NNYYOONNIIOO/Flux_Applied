...
public class ItemFluxStorageCell extends Item implements IEnergyStorage, IFluxStorageCell
{
    ...
    public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag flag) {
        ...
        if (totalBytes > 0) {
            tooltip.add(I18n.translateToLocalFormatted("flux_applied.tooltip.bytes_used", usedBytes, totalBytes));
            tooltip.add(I18n.translateToLocalFormatted("flux_applied.tooltip.stored_fe", stored));
        }
    }
