...
{
    public static final long MAX_ENERGY = Long.MAX_VALUE;  // long 上限: 9,223,372,036,854,775,807
    public static final int DEFAULT_MAX_TRANSFER = Integer.MAX_VALUE;  // int 上限: 2,147,483,647
    ...
    public void toggleMode(EntityPlayer player) {
        ...
        player.sendMessage(new TextComponentTranslation(modeKey));
    }
